...
const darkTheme = {
  ...
  background: "linear-gradient(180deg, #2D4A20 0%, #153418 100%)",
  paperBg: "linear-gradient(220deg, #50843A -30%, #142518 50%)",
  modalBg: "#24242699",
          ...
          MuiCssBaseline: {
            ...
            body {
              ...
              @media (min-width: 981px) {
                  background-image:${darkTheme.backgroundImage};
                  background-size:86vw 100vh;
                  background-position:right;
              }
              @media (min-width: ${commonSettings.breakpoints.values.xl}px) {
